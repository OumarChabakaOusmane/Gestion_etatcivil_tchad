...
export const translations = {
    fr: {
        ...
        addrLabel: "Adresse",
        addrValue: "Abeche, Tchad",
        phoneLabel: "Téléphone",
        phoneValue: "+235 62 96 55 33",
        emailLabel: "Email",
        hoursLabel: "Horaires",
        ...
        // Death Declaration labels
        deathDeclTitle: "Déclaration de décès",
        deathDeclSubtitle: "Service d'État Civil - République du Tchad",
        deceasedInfo: "Informations sur le défunt",
        declarantInfo: "Informations sur le déclarant",
        finalValidation: "Validation finale",
        labelNomDefunt: "Nom du défunt",
        labelPrenomDefunt: "Prénom(s) du défunt",
        labelSexe: "Sexe",
        labelNNI: "Référence NNI / Numéro National d'Identité",
        labelDateDeces: "Date du décès",
        labelLieuDeces: "Lieu du décès",
        labelCauseDeces: "Cause du décès (si connue)",
        labelProfession: "Profession du défunt",
        labelPereDefunt: "Fils de (Père)",
        labelMereDefunt: "Et de (Mère)",
        labelDateNaisDefunt: "Date de naissance",
        labelLieuNaisDefunt: "Lieu de naissance",
        labelNationalite: "Nationalité",
        labelNomDeclarant: "Nom du déclarant",
        labelPrenomDeclarant: "Prénom(s) du déclarant",
        labelLienParente: "Lien de parenté",
        labelDomicileDeclarant: "Domicile du déclarant",
        labelSummaryTitle: "Résumé de la déclaration",
        labelStepPrev: "Précédent",
        labelStepNext: "Continuer",
        labelStepSubmit: "Soumettre la déclaration",
        labelProcessing: "Traitement...",
        labelLegalNotice: "La déclaration de décès est une obligation légale devant être effectuée dans les plus brefs délais.",
        msgSuccessDeces: "Déclaration de décès soumise avec succès !",
        msgErrorRequired: "Veuillez remplir tous les champs obligatoires :",
        labelDocuments: "Pièces Justificatives (Optionnel)",
        labelUploadDoc: "Télécharger un document (CNI, Photo...)",
        labelDocsDesc: "Ajoutez des photos ou scans de vos documents pour accélérer le traitement.",
    },
    ar: {
        welcome: "مرحباً",
        ...
        btnCancel: "إلغاء",
        btnConfirmRejet: "رفض",
        // Death Declaration labels (Arabic)
        deathDeclTitle: "تصريح الوفاة",
        deathDeclSubtitle: "الحالة المدنية - جمهورية تشاد",
        deceasedInfo: "معلومات عن المتوفى",
        declarantInfo: "معلومات عن المصرح",
        finalValidation: "التحقق النهائي",
        labelNomDefunt: "اسم المتوفى",
        labelPrenomDefunt: "الاسم (الأول) للمتوفى",
        labelSexe: "الجنس",
        labelNNI: "الرقم الوطني للهوية",
        labelDateDeces: "تاريخ الوفاة",
        labelLieuDeces: "مكان الوفاة",
        labelCauseDeces: "سبب الوفاة (إذا كان معروفاً)",
        labelProfession: "مهنة المتوفى",
        labelPereDefunt: "ابن (الأب)",
        labelMereDefunt: "و (الأم)",
        labelDateNaisDefunt: "تاريخ الميلاد",
        labelLieuNaisDefunt: "مكان الميلاد",
        labelNationalite: "الجنسية",
        labelNomDeclarant: "اسم المصرح",
        labelPrenomDeclarant: "الاسم الأول للمصرح",
        labelLienParente: "صلة القرابة",
        labelDomicileDeclarant: "سكن المصرح",
        labelSummaryTitle: "ملخص التصريح",
        labelStepPrev: "السابق",
        labelStepNext: "متابعة",
        labelStepSubmit: "تقديم التصريح",
        labelProcessing: "جاري المعالجة...",
        labelLegalNotice: "يعتبر التصريح بالوفاة التزاماً قانونياً يجب القيام به في أقرب وقت ممكن.",
        msgSuccessDeces: "تم تقديم تصريح الوفاة بنجاح!",
        msgErrorRequired: "يرجى ملء جميع الحقول الإلزامية:",
        labelDocuments: "الوثائق الثبوتية (اختياري)",
        labelUploadDoc: "تحميل وثيقة (بطاقة هوية، صورة...)",
        labelDocsDesc: "أضف صوراً أو نسخاً ضوئية من وثائقك لتسريع المعالجة.",
    }
};
